        ...
        $('body').on('click', '.btn-book-more', (event) => {
            ...
            if (customer) {
                ...
                if (variantJson.length>0) {
                    ...
                    vButton=`<div class="find-btn-apply button button--primary" data-book-sku="${productSku}" data-book-product='${productName}' data-book-quantity='1'>sign up</div><script>var pJson = ${variantJson}; console.log(pJson);</script>`;
                } else {
